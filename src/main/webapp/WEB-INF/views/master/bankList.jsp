			...
			<div class="content">
				...
				<div class="card">
					...
					<div class="card-header header-elements-inline">
						<table width="100%">
							<tr width="100%">
								<td width="60%"><h5 class="card-title">Bank List</h5></td>
								...
								<c:forEach items="${bankList}" var="bankList"
									...
									<tr>
										...
										<td class="text-center"><c:if test="${editAccess == 0}">
												<a
													href="${pageContext.request.contextPath}/editBank?bankId=${bankList.exVar1}"
											...
											<a href="javascript:void(0)"
													...
													data-uuid="${bankList.exVar1}" data-popup="tooltip"
