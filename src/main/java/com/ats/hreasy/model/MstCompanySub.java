...
public class MstCompanySub {
	...
	public String getPfCoverageDate() {
		return pfCoverageDate;
	}

	public void setPfCoverageDate(String pfCoverageDate) {
	...
	public String getEsicCoverageDate() {
		return esicCoverageDate;
	}

	public void setEsicCoverageDate(String esicCoverageDate) {
	...
	public String toString() {
		return "MstCompanySub [companyId=" + companyId + ", companyName=" + companyName + ", nameSd=" + nameSd
				...
				+ ", exInt2=" + exInt2 + ", exVar1=" + exVar1 + ", exVar2=" + exVar2 + ", isActive=" + isActive + "]";
	}
